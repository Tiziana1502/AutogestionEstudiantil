            ...
            switch (opcion) {
                ...
                case 2: {
                    ...
                    do {
                        ...
                        System.out.print("Opcion: ");                       
                        try {
                            opcion2 = Integer.parseInt(sc.nextLine().trim());
                        } catch (Exception e) {
                            System.out.println("Error: Debes ingresar un numero valido.");
                            opcion2 = -1;
                            continue;
                        ...
                        switch (opcion2) {
                                ...
                                while (!datoValido) {
                                    try {
                                        ...
                                        if (tipo == 2) {
                                            ...
                                            int cuatrimestre = Integer.parseInt(sc.nextLine().trim());
                                        ...
                                        System.out.println("\n[ERROR] Debes ingresar un numero valido donde corresponde.");
                            ...
                            case 4: {
                                ...
                                int opcion3;                                
                                try {
                                    opcion3 = Integer.parseInt(sc.nextLine().trim());
                                } catch (Exception e) {
                                    System.out.println("Error: Debes ingresar un numero valido.");
                                    break;
                                }
                ...
                case 3: { // Registro de asistencias
                    ...
                    if (insEncontrada != null) {
                        ...
                        int presente;                        
                        try {
                            presente = Integer.parseInt(sc.nextLine().trim());
                        } catch (Exception e) {
                            System.out.println("Error: Debes ingresar 1 o 0.");
                            break;
                        }
                ...
                case 5: {
                    ...
                    do {
                        ...
                        System.out.print("Opcion: ");                       
                        try {
                            opcion4 = Integer.parseInt(sc.nextLine().trim());
                        } catch (Exception e) {
                            System.out.println("Error: Debes ingresar un numero valido.");
                            opcion4 = -1;
                            continue;
                        ...
                        switch (opcion4) {
                            ...
                            case 2: {
                                ...
                                if (riesgo.isEmpty()) {
                                    System.out.println("No se encontraron materias en este rango.");
                                } else {
                            ...
                            case 3: {
                                ...
                                if (contadorAprobadas > 0) {
                                    ...
                                    System.out.println("No se encontraron materias aprobadas.");
                                }
                                break;
                            }
                            case 4: {
                    ...
                    } while (opcion4 != 0); // ← loop hasta que el usuario elija Volver
                    break;
                } 
                case 0:
